...
public class CarRental {
    public static void main(String[] args) {
        System.out.println("Welcome to the homework.week01.Car Rental!");
                ...
                for (Car car : cars) {
                    if (car.getPlate() == carNumber) {
                        if (car.isRented()) {
                            ...
                            car.rented = true;
                            System.out.println("homework.week01.Car rented!");
                        }
                        rented = true;
                        break;
                    }
                ...
                for (Car car : cars) {
                    if (car.getPlate() == carNumber) {
                        ...
                        if (!car.isRented()) {
                            ...
                            car.addKm(newKm);
                            System.out.println("homework.week01.Car returned!");
                            car.returnCar();
                        }
                        break;
                    }
